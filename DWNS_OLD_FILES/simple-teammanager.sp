...
*************************************************************************
File Information
$Id: simple-teammanager.sp 54 2009-10-10 08:37:08Z antithasys $
$Author: antithasys $
$Revision: 54 $
$Date: 2009-10-10 01:37:08 -0700 (Sat, 10 Oct 2009) $
$LastChangedBy: antithasys $
$LastChangedDate: 2009-10-10 01:37:08 -0700 (Sat, 10 Oct 2009) $
$URL: http://sm-simple-plugins.googlecode.com/svn/trunk/Simple%20Team%20Manager/addons/sourcemod/scripting/simple-teammanager.sp $
...
#define PLUGIN_VERSION "2.1.$Rev: 54 $"
#define VOTE_YES "##YES##"
#define VOTE_NO "##NO##"
...
new bool:g_bSuddentDeath = false;
...
public OnPluginStart()
{
	...
	*/
	...
	HookEvent("teamplay_round_stalemate", HookSuddentDeath, EventHookMode_Pre);
	switch (g_CurrentMod)
	{
		case GameType_TF:
		{
...
public Action:Command_SwapTeam(client, args)
{
	...
	*/
	...
	{
		ReplyToCommand(client, "\x01\x04[SM]\x01 Cannot Swap Teams After A Scramble!");
		return Plugin_Handled;
	}
...
public HookSuddentDeath(Handle:event, const String:name[], bool:dontBroadcast)
{
	g_bSuddentDeath = true;
}
