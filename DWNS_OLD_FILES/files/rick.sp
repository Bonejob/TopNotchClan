...
public OnPluginStart() {
	...
	RulesURL = CreateConVar("sm_rick_url","http://topnotchclan.nuclearfallout.net/mp3/rick.html","Set this to the URL of your MOTD/Rules.");
...
public PerformMOTD(client, target) {
	if (client != target) {
		...
		PrintToChatAll("%c[MOTD] %c%s %s %s %s",COLOR_GREEN,COLOR_DEFAULT,clientName,"just rick rolled",targetName,"!");
	}
