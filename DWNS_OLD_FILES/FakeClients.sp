...
static String:FakeNames[32][] = {"System32", "TommyBoy", "RogerDodger", "BulletsLikeMe", "b!g", "ScoutItOut", "PopularAttraction", "Squ33z3", "quality", "bailoutnow", "ph34r", "1337sp34k", "soopaMAN", "L33t", "omar", "achmed", "benthas", "hmmmm", "LOLLOL", "i.ride.the.short.bus", "roastAbowl", "winnt.dll", "Burritos", "freeman", "alyx", "barney", "g-man", "xcellent", "obtuse", "Moridin", "Rand", "YoungBull"};
...
public OnPluginStart(){
	...
	MaxFakeClientAllowed = CreateConVar("sm_fakeclients_players","4","Number of players to simulate", FCVAR_PLUGIN|FCVAR_SPONLY|FCVAR_REPLICATED|FCVAR_NOTIFY, true, 0.0, true, 64.0);
	FakeClientsDelay = CreateConVar("sm_fakeclients_delay","120","Delay after map change before fake clients join (seconds)", FCVAR_PLUGIN|FCVAR_SPONLY|FCVAR_REPLICATED|FCVAR_NOTIFY, true, 0.1, true, 10.0);
}
