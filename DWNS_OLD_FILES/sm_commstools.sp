...
public OnPluginStart()
{
	...
	g_Cvar_Message = CreateConVar("sm_commstools_msg", "See http://www.topnotchclan.com to inquire.", "Message sent when player is muted/gagged/silenced")
	...
	SQL_TConnect(DBConnect, "default")
