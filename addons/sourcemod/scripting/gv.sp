...
public OnPluginStart()
{
	...
	// enable disable
	g_banenable 		= 	CreateConVar("gv_ban_enable", "0", "Enable or disable ban function.");
	...
	// morecolors
	g_morecolors		=  	CreateConVar("gv_support_morecolors", "1", "Enable colors in chat.");
...
public gvBanPlayer(clientGvID, clientUserID, String:ClientName[])
{
	...
	if(gaclogs) 
	{
		...
		GetClientAuthId(clientUserID, AuthId_Steam2, steamid, sizeof(steamid)); 
